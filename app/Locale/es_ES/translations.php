...
return array(
    ...
    'Unable to remove this action.' => 'No se puede suprimir esta acción.',
    ...
    'Define action parameters' => 'Definición de los parámetros de la acción',
    ...
    'Unable to clone this project.' => 'Imposible clonar proyecto',
    ...
    'Period (in second) to consider a task was modified recently (0 to disable, 2 days by default)' => 'Periodo (en segundos) para considerar que una tarea ha sido modificada recientemente (0 para desactivar, 2 días por defecto))',
    ...
    'Exports' => 'Exportar',
    'This export contains the number of tasks per column grouped per day.' => 'Esta exportación contiene el número de tareas por columna agrupada por día',
    ...
    'VES - Venezuelan Bolívar' => 'VES - Bolívar venezolano',
    ...
    'There is no custom role for this project.' => 'No hay ningún  rol personalizado para este proyecto.',
    ...
    'Outgoing Emails' => 'Correos electrónicos salientes',
    ...
    'Assigned' => 'Asignado',
    'Task limits apply to each swimlane individually' => 'Los límites de la tarea se aplican a cada Swimlane individualmente',
    'Column task limits apply to each swimlane individually' => 'Los límites de la tarea de la columna se aplican a cada Swimlane individualmente',
    'Column task limits are applied to each swimlane individually' => 'Los límites de la tarea de la columna se aplican a cada Swimlane individualmente',
    'Column task limits are applied across swimlanes' => 'Los límites de la tarea de la columna se aplican a través de Swimlanes',
    'Task limit: ' => 'Límite de tareas',
    'Change to global tag' => 'Cambiar a etiqueta global',
    'Do you really want to make the tag "%s" global?' => '¿Realmente quieres que la etiqueta "%s" sea global?',
    'Enable global tags for this project' => 'Habilitar las etiquetas globales para este proyecto',
    'Group membership(s):' => 'Afiliación al grupo(s)',
    '%s is a member of the following group(s): %s' => '%s es miembro de los siguientes grupos: %s',
    '%d/%d group(s) shown' => '%d/%d grupo(s) mostrado(s)',
    'Subtask creation or modification' => 'Creación o modificación de subtareas',
    'Assign the task to a specific user when the task is moved to a specific swimlane' => 'Asigne la tarea a un usuario específico cuando la tarea se mueva a un Swimlane específico',
    'Comment' => 'Comentario',
    'Collapse vertically' => 'Colapsar verticalmente',
    'Expand vertically' => 'Expandir verticalmente',
    'MXN - Mexican Peso' => 'MXN - Peso mexicano',
    'Estimated vs actual time per column' => 'Tiempo estimado frente a tiempo real por columna',
    'HUF - Hungarian Forint' => 'HUF - Florín húngaro',
    'XBT - Bitcoin' => 'XBT - Bitcoin',
    'You must select a file to upload as your avatar!' => '¡Debe seleccionar un archivo para cargar como avatar!',
    'The file you uploaded is not a valid image! (Only *.gif, *.jpg, *.jpeg and *.png are allowed!)' => '¡El archivo que cargó no es una imagen válida! (Sólo se permiten los archivos *.gif, *.jpg, *.jpeg y *.png)',
    'Automatically set the due date when the task is moved away from a specific column' => 'Configuración automática de la fecha de vencimiento al salir de una determinada columna',
);
